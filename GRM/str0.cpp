...
bool _WStr1CheckSLen(const wstr1* other, size_t s, size_t len)
{
	const size_t lenOther = WSTR1_LEN(other);
	return s < lenOther&& len <= lenOther - s;
}
...
{
	wstr1 strTmp;
	const int32_t ret = _WStr1PureMakeBy2(&strTmp, other, s, len);
	RET_ON_NEG(ret);
...
int32_t _WStr1PureMakeBy2(wstr1* str, const wstr1* other, size_t s, size_t len)
{
	if (WSTR1_ISNULL(other))
		return GRET_INVSTATUS;
	if (!_WStr1CheckSLen(other, s, len))
		return GRET_INVIDX;
...
{
	return WStr1MakeCSBy2(str, &c, 0, 1);
}
...
int32_t WStr1MakeCS(wstr1* str, const wch* pcs)
{
	if (NULL == pcs)
		return GRET_NULL;
	return WStr1MakeCSBy2(str, pcs, 0, wcslen(pcs));
}
...
{
	wstr1 strTmp;
	const int32_t ret = WStr1PureMakeCSBy2(&strTmp, pcs, s, len);
	RET_ON_NEG(ret);
	return _WStr1Move(str, &strTmp);
}
...
int32_t WStr1MakeCSFromPos(wstr1* str, const wch* pcs, size_t s)
{
	if (NULL == pcs)
		return GRET_NULL;
	const size_t lenPCS = wcslen(pcs);
	if (s >= lenPCS)
		return GRET_INVIDX;
	return WStr1MakeCSBy2(str, pcs, s, lenPCS - s);
}
...
int32_t WStr1Make(wstr1* str, const wstr1* other)
{
	...
	if (WSTR1_ISNULL(other))
		return _WStr1Release(str);
	return _WStr1MakeBy2(str, other, 0, WSTR1_LEN(other));
}
...
int32_t WStr1MakeBy2(wstr1* str, const wstr1* other, size_t s, size_t len)
{
	if (NULL == str || NULL == other)
		return GRET_NULL;
	return _WStr1MakeBy2(str, other, s, len);
}
...
int32_t WStr1MakeFromPos(wstr1* str, const wstr1* other, size_t s)
{
	if (NULL == str || NULL == other)
		return GRET_NULL;
	// do not check other null status
	return _WStr1MakeBy2(str, other, s, WSTR1_LEN(other) - s);
}
...
{
	return WStr1PureMakeCSBy2(str, &c, 0, 1);
}
...
int32_t WStr1PureMakeCS(wstr1* str, const wch* pcs)
{
	if (NULL == pcs)
		return GRET_NULL;
	return WStr1PureMakeCSBy2(str, pcs, 0, wcslen(pcs));
}
...
int32_t WStr1PureMakeCSFromPos(wstr1* str, const wch* pcs, size_t s)
{
	...
	if (s >= lenPCS)
		return GRET_INVIDX;
	return WStr1PureMakeCSBy2(str, pcs, s, lenPCS);
}
...
int32_t WStr1PureMake(wstr1* str, const wstr1* other)
{
	...
	return _WStr1PureMakeBy2(str, other, 0, WSTR1_LEN(other));
}
...
int32_t WStr1PureMakeBy2(wstr1* str, const wstr1* other, size_t s, size_t len)
{
	if (NULL == str || NULL == other)
		return GRET_NULL;
	return _WStr1PureMakeBy2(str, other, s, len);
}
...
int32_t WStr1PureMakeFromPos(wstr1* str, const wstr1* other, size_t s)
{
	if (NULL == str || NULL == other)
		return GRET_NULL;
	// do not check other null status
	return _WStr1PureMakeBy2(str, other, s, WSTR1_LEN(other) - s);
}
...
int32_t WStr1CopyFromPos(wstr1* str, const wstr1* other, size_t s)
{
	if (NULL == str || NULL == other)
		return GRET_NULL;
	// do not check other null status
	return _WStr1CopyBy2(str, other, s, WSTR1_LEN(other) - s);
}
...
int32_t WStr1PureCopyFromPos(wstr1* str, const wstr1* other, size_t s)
{
	if (NULL == str || NULL == other)
		return GRET_NULL;
	// do not check other null status
	return _WStr1PureCopyBy2(str, other, s, WSTR1_LEN(other) - s);
}
...
int32_t _WStr1RefBy2(wstr1* str, const wstr1* other, size_t s, size_t len)
{
	...
	// check overlap
	if (!WSTR1_ISREF(str)
		&& _PtrOverlapWCH(WSTR1_STR(str), WSTR1_LEN(str), WSTR1_STR(other) + s, len))
		return GRET_INVOP;
...
int32_t WStr1RefCS(wstr1* str, wch* pcs)
{
	if (NULL == pcs)
		return GRET_NULL;
	return WStr1RefCSBy2(str, pcs, 0, wcslen(pcs));
}
...
{
	wstr1 strTmp;
	const int32_t ret = WStr1PureRefCSBy2(&strTmp, pcs, s, len);
	RET_ON_NEG(ret);
	return _WStr1Move(str, &strTmp);
}
...
int32_t WStr1RefCSFromPos(wstr1* str, wch* pcs, size_t s)
{
	...
	if (s >= lenPCS)
		return GRET_INVIDX;
	return WStr1RefCSBy2(str, pcs, s, lenPCS - s);
}
...
int32_t WStr1Ref(wstr1* str, const wstr1* other)
{
	if (NULL == str || NULL == other)
		return GRET_NULL;
	// do not check other null status
	return _WStr1RefBy2(str, other, 0, WSTR1_LEN(other));
}
...
int32_t WStr1RefBy2(wstr1* str, const wstr1* other, size_t s, size_t len)
{
	if (NULL == str || NULL == other)
		return GRET_NULL;
	return _WStr1RefBy2(str, other, s, len);
}
...
int32_t WStr1RefFromPos(wstr1* str, const wstr1* other, size_t s)
{
	if (NULL == str || NULL == other)
		return GRET_NULL;
	// do not check other null status
	return _WStr1RefBy2(str, other, s, WSTR1_LEN(other) - s);
}
...
int32_t WStr1Deref(wstr1* str)
{
	...
	if (!WSTR1_ISREF(str))
		return GRET_INVSTATUS;
	return WStr1MakeCSBy2(str, WSTR1_STR(str), 0, WSTR1_LEN(str));
}
...
int32_t WStr1PureRefCS(wstr1* str, wch* pcs)
{
	if (NULL == pcs)
		return GRET_NULL;
	return WStr1PureRefCSBy2(str, pcs, 0, wcslen(pcs));
}
...
int32_t WStr1PureRefCSFromPos(wstr1* str, wch* pcs, size_t s)
{
	...
	if (s >= lenPCS)
		return GRET_INVIDX;
	return WStr1PureRefCSBy2(str, pcs, s, lenPCS - s);
}
...
int32_t WStr1PureRef(wstr1* str, const wstr1* other)
{
	if (NULL == str || NULL == other)
		return GRET_NULL;
	return _WStr1PureRefBy2(str, other, 0, WSTR1_LEN(other));
}
...
int32_t WStr1PureRefBy2(wstr1* str, const wstr1* other, size_t s, size_t len)
{
	if (NULL == str || NULL == other)
		return GRET_NULL;
	return _WStr1PureRefBy2(str, other, s, len);
}
...
int32_t WStr1PureRefFromPos(wstr1* str, const wstr1* other, size_t s)
{
	if (NULL == str || NULL == other)
		return GRET_NULL;
	// do not check other null status
	return _WStr1PureRefBy2(str, other, s, WSTR1_LEN(other) - s);
}
